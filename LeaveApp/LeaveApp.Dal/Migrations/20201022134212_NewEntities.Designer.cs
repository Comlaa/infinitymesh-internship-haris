...
namespace LeaveApp.Dal.Migrations
{
    ...
    [Migration("20201022134212_NewEntities")]
            ...
            modelBuilder.Entity("LeaveApp.Dal.Domain.UserLeave", b =>
                {
                    ...
                    b.Property<int?>("UserReplacmentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveApp.Dal.Domain.UserLeave", b =>
                {
                    ...
                    b.HasOne("LeaveApp.Dal.Domain.User", "UserReplacment")
                        .WithMany()
                        .HasForeignKey("UserReplacmentId");
                });
